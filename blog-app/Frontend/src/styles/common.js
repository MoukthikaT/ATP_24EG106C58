...
// Inspired by apple.com — clean typography, subtle grays, blue accents
...
export const formCard =
  "bg-[#f5f5f7] border border-[#e8e8ed] rounded-2xl p-10 max-w-4xl mx-auto";
export const formTitle =
  "text-2xl font-bold text-[#1d1d1f] tracking-tight text-center mb-7";
export const labelClass =
  "text-xs font-medium text-[#6e6e73] mb-1.5 block";
export const inputClass =
  "w-full bg-white border border-[#d2d2d7] rounded-xl px-4 py-2.5 text-[#1d1d1f] text-sm placeholder:text-[#a1a1a6] focus:outline-none focus:border-[#0066cc] focus:ring-2 focus:ring-[#0066cc]/20 transition";
export const formGroup = "mb-4";
export const submitBtn =
  "w-full bg-[#0066cc] text-white font-semibold py-2.5 rounded-full hover:bg-[#004499] disabled:bg-[#99c2e6] transition-colors cursor-pointer mt-2 text-sm tracking-tight";
...
export const errorClass =
  "bg-[#ff3b30]/[0.06] text-[#cc2f26] border border-[#ff3b30]/[0.18] rounded-xl px-4 py-3 text-sm shadow-sm";
export const successClass =
  "bg-[#34c759]/[0.07] text-[#248a3d] border border-[#34c759]/20 rounded-xl px-4 py-3 text-sm shadow-sm";
...
export const commentText =
  "text-[#1d1d1f] text-sm leading-relaxed mt-1";
export const avatar =
